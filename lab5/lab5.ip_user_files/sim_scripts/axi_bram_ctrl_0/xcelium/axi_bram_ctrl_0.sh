...
#
# Script generated by Vivado on Mon Dec 01 16:15:40 EST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_bram_ctrl_0.sh
...
#
# Usage        : axi_bram_ctrl_0.sh
#                axi_bram_ctrl_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_bram_ctrl_0.sh [-reset_run]
#                axi_bram_ctrl_0.sh [-reset_log]
#                axi_bram_ctrl_0.sh [-help]
#
...
#                script (type 'axi_bram_ctrl_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_bram_ctrl_v4_1_13 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_bram_ctrl_v4_1_13 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_bram_ctrl_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_bram_ctrl_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../scratch/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_bram_ctrl_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_bram_ctrl_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_bram_ctrl_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_bram_ctrl_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_bram_ctrl_0.sh [-help]\n\
Usage: axi_bram_ctrl_0.sh [-step]\n\
Usage: axi_bram_ctrl_0.sh [-lib_map_path]\n\
Usage: axi_bram_ctrl_0.sh [-reset_run]\n\
Usage: axi_bram_ctrl_0.sh [-reset_log]\n\
Usage: axi_bram_ctrl_0.sh [-keep_index]\n\
Usage: axi_bram_ctrl_0.sh [-noclean_files]\n\n\
